...
private let appleScriptErrorMessage =
    "Hammerspoon's AppleScript support is currently disabled. " +
    "Please enable it in Hammerspoon by using the hs.allowAppleScript(true) command."
    ...
    override func performDefaultImplementation() -> Any? {
        ...
        guard args.count > 0, let stringToExecute = args[""] as? String else {
            ...
            scriptErrorString =
                ...
                "You need to tell Hammerspoon what Lua code you want to execute."
            return "Error"
        }
