...
-- the ultimate goal with the following is to allow anyone who has *only* Cosmic Hammer to build
...
--- Function
--- Generates a JSON string representation of the documentation source specified. This is the format expected by `hs.doc` and `hs.doc.hsdoc` and is used to provide the built in documentation for Cosmic Hammer.
---
--- Parameters:
...
-- eventually this will be the starting point for generating your own local copy of the Cosmic Hammer documentation
module.commentsFromCosmicHammerSource = function(src)
    return module.genComments{ src.."/extensions", src.."/CosmicHammer" }
end
