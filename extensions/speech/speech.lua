...
---
--- The speech recognizer functions and methods provide a way to add commands which may be issued to Cosmic Hammer through spoken words and phrases to trigger a callback.
